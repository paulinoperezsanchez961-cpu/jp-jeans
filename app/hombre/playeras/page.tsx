...
export default function PlayerasHombrePage() {
  ...
  useEffect(() => {
    // CARGAMOS LOS PRODUCTOS REALES (Hombre + Playera)
    fetch(`${BASE_URL}/web/catalogo?genero=Hombre&tipo=Playera`)
      .then(res => res.json())
      .then(data => {
        if (data.exito) {
          const mapeados = data.productos.map((p: any) => {
            ...
            return {
              ...
              descripcion: p.descripcion || 'Playera de lujo de la colección JP Jeans.',
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-black">
            ...
            {!isLoaded ? (
              ...
              <div className="col-span-2 md:col-span-4 bg-white py-24 text-center flex flex-col items-center">
                <p className="text-black text-[10px] md:text-xs tracking-widest uppercase mb-4">No hay playeras disponibles bajo este filtro.</p>

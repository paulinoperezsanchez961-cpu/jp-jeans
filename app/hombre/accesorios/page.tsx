...
// 1. BASE DE DATOS DE ACCESORIOS HOMBRE
const productosDb = [
  { id: 'AH-01', nombre: 'Gorra Signature Logo', precio: 599, tipo: 'Gorras', color: 'Negro',
    ...
    imgHover: 'https://images.unsplash.com/photo-1576871337632-b9aef4c17ab9?q=80&w=800' 
  },
  ...
  { id: 'AH-05', nombre: 'Anillo Sello Acero', precio: 899, tipo: 'Joyería', color: 'Plata',
    ...
    imgHover: 'https://images.unsplash.com/photo-1599643478514-4a48489c1653?q=80&w=800' 
  },
  { id: 'AH-06', nombre: 'Crossbody Bag Black', precio: 1599, tipo: 'Bolsos', color: 'Negro',
    ...
    imgHover: 'https://images.unsplash.com/photo-1624222247344-550fb60583dc?q=80&w=800'
  }
];
        ...
        <div className="w-full bg-black text-white px-4 md:px-8 py-5 md:py-6 flex flex-row justify-between items-center text-[10px] md:text-xs tracking-widest uppercase relative z-20">
          ...
          <div className="flex items-center justify-end space-x-8">
            <button 
              ...
              className={`transition-opacity ${filtroTipo ? 'border-b border-white' : 'hover:opacity-70'}`}
            >
            ...
            <button 
              ...
              className={`transition-opacity ${filtroColor ? 'border-b border-white' : 'hover:opacity-70'}`}
            >

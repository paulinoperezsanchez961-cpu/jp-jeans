...
const imagenes = {
  ...
  heroDesktop: 'https://images.unsplash.com/photo-1480455624313-e29b44bbfde1?q=80&w=2000', // Foto horizontal para PC
  heroMobile: 'https://images.unsplash.com/photo-1516826957135-73318231cb6c?q=80&w=800',  // Foto vertical para Celular
    ...
    <div className="bg-white min-h-screen w-full flex flex-col">
      ...
      <section className="w-full px-4 md:px-8 py-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          {[
            { href: '/hombre/jeans', label: 'Jeans', img: imagenes.jeans },
            { href: '/hombre/chamarras', label: 'Chamarras', img: imagenes.chamarras },
            { href: '/hombre/playeras', label: 'Playeras', img: imagenes.playeras },
            { href: '/hombre/accesorios', label: 'Accesorios', img: imagenes.accesorios }
          ].map((item, i) => (

...
export default function NovedadesPage() {
  ...
  useEffect(() => {
    ...
    // 2. CONECTAMOS AL CEREBRO PIDIENDO SÓLO LO MÁS NUEVO (?novedades=true)
  ...
  return (
    <div className="bg-white min-h-screen w-full flex flex-col font-sans">
      ...
      {/* 2. BANNER PRINCIPAL (HERO) - CERO RECORTES (9:16 y 16:9) */}
      <section className="w-full relative aspect-[9/16] md:aspect-[16/9] overflow-hidden bg-black">
        <AnimatePresence>
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1.5 }} className="absolute inset-0">
            {/* Imagen Móvil */}
            <img 
              src="https://images.unsplash.com/photo-1516826957135-73318231cb6c?q=80&w=800" 
              alt="Novedades Móvil" 

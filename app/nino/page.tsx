...
// 1. BASE DE DATOS DE NIÑO
const productosDb = [
  { id: 'NO-01', nombre: 'Jeans Baggy Kids', precio: 899, tipo: 'Jeans', tallas: ['6', '8', '10'],
  ...
  { id: 'NO-02', nombre: 'Playera Graphic Skate', precio: 459, tipo: 'Playeras', tallas: ['4', '6', '8'],
  ...
  { id: 'NO-03', nombre: 'Sudadera Essential Grey', precio: 799, tipo: 'Sudaderas', tallas: ['8', '10', '12'],
  ...
  { id: 'NO-04', nombre: 'Chamarra Denim Black', precio: 1299, tipo: 'Chamarras', tallas: ['6', '8', '10', '12'],
  ...
  { id: 'NO-05', nombre: 'Cargo Pants Utility', precio: 999, tipo: 'Jeans', tallas: ['4', '6', '10'],
    img: 'https://images.unsplash.com/photo-1471286174890-9c112cbcd5b8?q=80&w=800', 
    imgHover: 'https://images.unsplash.com/photo-1622290291468-a28f7a7dc6a8?q=80&w=800' 
  },
  { id: 'NO-06', nombre: 'Playera Básica Logo', precio: 399, tipo: 'Playeras', tallas: ['10', '12'],
...
export default function NinoPage() {
  ...
  return (
    <div className="bg-white min-h-screen w-full flex flex-col font-sans">
      ...
      {/* 2. BANNER PRINCIPAL (HERO) PANTALLA COMPLETA */}
      {/* Al no tener el bloque negro arriba, la imagen topa hasta el techo y tu navbar flota perfecto encima */}
      <section className="w-full h-[85vh] md:h-screen relative overflow-hidden">
        <img
          src="https://images.unsplash.com/photo-1471286174890-9c112cbcd5b8?q=80&w=2000"
          alt="Colección Niño"
          ...
          <div className="absolute top-full left-0 w-full bg-white text-black border-b border-black shadow-xl z-10 px-8 py-8 text-[10px] md:text-xs tracking-widest uppercase animate-in slide-in-from-top-2 duration-300">
            ...
            {menuAbierto === 'tipo' && (
              <div className="flex space-x-12">
                {['Jeans', 'Playeras', 'Chamarras', 'Sudaderas'].map(t => (

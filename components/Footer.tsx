      ...
      <div className="max-w-[1800px] mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between border-b border-white/10 pb-10 mb-12">
          ...
          <div className="w-full md:w-1/3 flex justify-center mb-8 md:mb-0">
            <Link href="/" className="transition-opacity hover:opacity-70">
              <img src="/JpJeans%20Blanco.png" alt="JP Jeans Logo" className="h-10 md:h-14 object-contain" />
            </Link>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 text-center md:text-left mb-16">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              <li><Link href="/informacion/contacto" className="font-sans font-light text-[11px] md:text-xs tracking-widest text-white/60 hover:text-white transition-colors">Contacto</Link></li>
              <li><Link href="/informacion/envios" className="font-sans font-light text-[11px] md:text-xs tracking-widest text-white/60 hover:text-white transition-colors">Envíos y Entregas</Link></li>
              <li><Link href="/informacion/devoluciones" className="font-sans font-light text-[11px] md:text-xs tracking-widest text-white/60 hover:text-white transition-colors">Devoluciones</Link></li>
              <li><Link href="/informacion/faq" className="font-sans font-light text-[11px] md:text-xs tracking-widest text-white/60 hover:text-white transition-colors">Preguntas Frecuentes</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              <li><Link href="/informacion/nosotros" className="font-sans font-light text-[11px] md:text-xs tracking-widest text-white/60 hover:text-white transition-colors">Sobre JP Jeans</Link></li>
              <li><Link href="/informacion/tiendas" className="font-sans font-light text-[11px] md:text-xs tracking-widest text-white/60 hover:text-white transition-colors">Nuestras Tiendas</Link></li>
              <li><Link href="/informacion/sustentabilidad" className="font-sans font-light text-[11px] md:text-xs tracking-widest text-white/60 hover:text-white transition-colors">Sustentabilidad</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              <li><Link href="/informacion/privacidad" className="font-sans font-light text-[11px] md:text-xs tracking-widest text-white/60 hover:text-white transition-colors">Política de Privacidad</Link></li>
              <li><Link href="/informacion/terminos" className="font-sans font-light text-[11px] md:text-xs tracking-widest text-white/60 hover:text-white transition-colors">Términos y Condiciones</Link></li>
              <li><Link href="/informacion/cookies" className="font-sans font-light text-[11px] md:text-xs tracking-widest text-white/60 hover:text-white transition-colors">Política de Cookies</Link></li>
            </ul>
          </div>
        ...
        <div className="w-full pt-8 text-center flex flex-col md:flex-row justify-between items-center opacity-40 gap-4 border-t border-white/10">
          <p className="font-sans font-light text-[9px] md:text-[10px] tracking-widest uppercase">
            © {new Date().getFullYear()} JP JEANS. TODOS LOS DERECHOS RESERVADOS.
          </p>
          <p className="font-sans font-light text-[9px] md:text-[10px] tracking-widest uppercase">
            DISEÑADO EN TLAXCALA, MÉXICO
          </p>
        </div>
